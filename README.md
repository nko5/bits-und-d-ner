...
~~~sh
# getting the code
git clone git@github.com:nko5/bits-und-d-ner.git && cd ./bits-und-d-ner/
...
# deploying to Modulus (to http://bits-und-d-ner.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/bits-und-d-ner" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
